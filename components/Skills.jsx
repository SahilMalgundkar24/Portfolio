    ...
    <>
      <div className="p-16">
        ...
        <div className="w-full flex justify-between mb-7">
          <div className="w-[31%] h-auto px-7 py-5 border border-[#BEBEBE] rounded-3xl">
            <h1 className="font-bold text-3xl text-[#BEBEBE] mb-10">O1</h1>
          ...
          <div className="w-[31%] h-auto px-7 py-5 border border-[#BEBEBE] rounded-3xl">
            <h1 className="font-bold text-3xl text-[#BEBEBE] mb-10">O2</h1>
          ...
          <div className="w-[31%] h-auto px-7 py-5 border border-[#BEBEBE] rounded-3xl">
            <h1 className="font-bold text-3xl text-[#BEBEBE] mb-10">O3</h1>
            <h1 className="font-medium text-xl">Mobile App Development</h1>
            <h1 className="font-medium text-lg text-[#9D9D9D]">React Native</h1>
          </div>
        </div>
        <div className="w-full h-auto px-7 py-5 border border-[#BEBEBE] rounded-3xl">
          <h1 className="font-bold text-3xl text-[#BEBEBE] mb-10">O4</h1>
